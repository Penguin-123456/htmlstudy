  ...
  var e = /\blang(?:uage)?-(?!\*)(\w+)\b/i,
    t = (self.Prism = {
      ...
      highlightElement: function (a, r, i) {
        ...
        if (
          (o &&
            ((l = (o.className.match(e) || [, ""])[1]), (s = t.languages[l])),
          s)
        ) {
          (a.className =
          ...
          var g = a.textContent;
          if (g) {
            var u = { element: a, language: l, grammar: s, code: g };
            if ((t.hooks.run("before-highlight", u), r && self.Worker)) {
              ...
              (c.onmessage = function (e) {
                ...
                c.postMessage(
                  JSON.stringify({ language: u.language, code: u.code })
                );
            } else
      ...
      "attr-value",
      {
        "style-attr": {
          ...
          inside: {
            ...
            punctuation: /^\s*=\s*['"]|['"]\s*$/,
            "attr-value": { pattern: /.+/gi, inside: Prism.languages.css },
          },
          alias: "language-css",
        },
      },
